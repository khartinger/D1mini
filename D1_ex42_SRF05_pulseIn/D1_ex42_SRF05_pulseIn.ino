...
//                |
// GND------------*-----GND
// Note: D3 not usable for echo because of Pull-up-Resistor 10k
...
#define PIN_TRIG        D3 // D5 or D4
#define PIN_ECHO        D5 // D6
...
void loop()
{
 ...
 durationUs = pulseIn(PIN_ECHO, HIGH, 5000); // measure time
 Serial.print("usec="+String(durationUs)+" --> ");
