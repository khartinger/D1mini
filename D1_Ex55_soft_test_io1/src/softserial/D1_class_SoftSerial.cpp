//_____D1_class_SoftSerial.cpp________________190101-190101_____
/*
SoftSerial.cpp - Implementation of the Arduino software serial for ESP8266.
...
#include "D1_class_SoftSerial.h"

#define MAX_PIN 15

// As the Arduino attachInterrupt has no parameter, lists of objects
// and callbacks corresponding to each possible GPIO pins have to be defined
SoftSerial *ObjList[MAX_PIN+1];
...
SoftSerial::SoftSerial(int receivePin, int transmitPin, bool inverse_logic, unsigned int buffSize) {
...
bool SoftSerial::isValidGPIOpin(int pin) {
...
long SoftSerial::baudRate() {
  return F_CPU/m_bitTime;
}

void SoftSerial::setTransmitEnablePin(int transmitEnablePin) {
...
void SoftSerial::enableIntTx(bool on) {
  m_intTxEnabled = on;
}

void SoftSerial::enableTx(bool on) {
...
void SoftSerial::enableRx(bool on) {
  if (m_rxValid) {
    if (on)
...
void ICACHE_RAM_ATTR SoftSerial::rxRead() {
